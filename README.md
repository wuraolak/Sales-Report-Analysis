...
- Calculated total sales(Revenue) using the formula
                   ...
                   =SUM(H2:H9922)
 which resulted in a total revenue of **2,101,090M**
...
This visuals below provides an analysis of the revenue generated by various product categories. The primary focus is on identifying which product categories are performing well and generating the most revenue. The results indicate that **shoes** have emerged as the leading category in terms of revenue contribution.

![](RevenuebyProduct.png)

-----

**2. Overall Total Sales Dashboard for year 2023 and 2024**
This report provides an analysis of total sales trends during the fiscal years 2023 and 2024. The data is visualized to  highlighting key sales metrics, seasonal trends, and overall growth rates year-over-year. Understanding these trends is crucial for making informed business decisions and strategies moving forward.

![](Overall.png)

----

**3. 2023 Dashboard to show the sales trend**

This report analyzes total sales trends during the fiscal year 2023. The report highlights key sales metrics, emphasizing the substantial revenue generated in 2023 compared to 2024 and the prominence of **shirt** as the leading product category by revenue in the year. Total revenue generated was **1.1M**. 
